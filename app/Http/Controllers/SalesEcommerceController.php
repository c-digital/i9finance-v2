...
class SalesEcommerceController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('salesEcommerce.index', compact('purchases', 'status','vender'));
    ...
    public function show($ids)
    {
        ...
        if(\Auth::user()->can('show purchase'))
        {
            ...
            $purchase = SaleEcommerce::find($id);
            ...
            if($purchase->created_by == \Auth::user()->creatorId())
            {
                ...
                return view('salesEcommerce.view', compact('purchase', 'vendor', 'iteams', 'purchasePayment'));
            }
            else
            {
    ...
    public function sent($id)
    {
        if(\Auth::user()->can('send purchase'))
        {
            ...
            $purchase->url = route('salesEcommerce.pdf', $purchaseId);
...
//        $img          = asset($logo . '/' . (isset($company_logo) && !empty($company_logo) ? $company_logo : 'logo-dark.png'));
        ...
        if($purchase)
        {
            ...
            return view('salesEcommerce.templates.' . $settings['purchase_template'], compact('purchase', 'color', 'settings', 'vendor', 'img', 'font_color'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
...
//        $purchase->due_date   = date('Y-m-d H:i:s');
        ...
        return view('salesEcommerce.templates.' . $template, compact('purchase', 'preview', 'color', 'img', 'settings', 'vendor', 'font_color'));
    }
...
//        $post['purchase_logo'] = $purchase_logo;
    ...
    public function purchaseLink($purchaseId)
    {
        ...
        if(!empty($purchase))
        {
            ...
            return view('salesEcommerce.customer_bill', compact('purchase', 'vendor', 'iteams','purchasePayment','user'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission Denied.'));
    ...
    public function payment($purchase_id)
    {
        if(\Auth::user()->can('create payment purchase'))
        {
            ...
            return view('salesEcommerce.payment', compact('venders', 'categories', 'accounts', 'purchase'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function vender(Request $request)
    {
        ...
        return view('salesEcommerce.vender_detail', compact('vender'));
    }
