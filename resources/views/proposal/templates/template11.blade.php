    ...
    <div class="page">
        <div class="d-flex justify-content-between">
            <div>
                ...
                <div class="row mt-5">
                    <div class="font-weight-bold">PROPUESTA {{Utility::proposalNumberFormat($settings,$proposal->proposal_id)}}</div>
                    <div>Fecha: {{Utility::dateFormat($settings,$proposal->issue_date)}}</div>
                </div>
            </div>
            ...
            <table>
                ...
                <tfoot style="border-top: 1px solid silver">
                    <tr>
                        <td colspan="5"></td>
                        <th class="text-right">{{ __('Discount') }}</th>
                        <td class="text-right">{{ Utility::priceFormat($settings,$proposal->getTotalDiscount()) }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{ Utility::priceFormat($settings,$proposal->getSubTotal()-$proposal->getTotalDiscount()+$proposal->getTotalTax()) }}</td>
                    </tr>
                </tfoot>
            </table>
        </div>
